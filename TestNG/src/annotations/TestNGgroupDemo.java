...
public class TestNGgroupDemo {
	...
	@Test(alwaysRun = true, groups = { "e2etest", "integrationtest"})
	public void testPrintMessage() {
		System.out.println("This method is run by both e2e and integration test");
	}
	@Test(alwaysRun = true, groups = {"e2etest"})
	public void testE2EMessage() {
		System.out.println("This method is run by e2e test");
	}
	@Test(alwaysRun = true, groups = {"integrationtest"})
	public void testingIntegrationMessage() {
		System.out.println("This method is run by integration test");
	}
	...
	@Test(alwaysRun = true, groups = { "e2etest", "acceptancetest", "integrationtest"})
